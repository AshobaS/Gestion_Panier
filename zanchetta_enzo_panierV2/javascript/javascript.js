...
import {ajaxData,datalist,dataprix} from "./ajax.js";
...
function setUpListener()
{
    ...
    code.addEventListener("input",conditionnerBouton);
...
//-------------------------------------------------------------------------------------
//Fonctions permettant le chargement du fichier json

window.addEventListener("load",ajaxData);
